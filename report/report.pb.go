...
type StatusReport struct {
	...
	LastTowerReachableTimestamp   string                 `protobuf:"bytes,3,opt,name=lastTowerReachableTimestamp,proto3" json:"lastTowerReachableTimestamp,omitempty"`     // testbed-monitor/report/receiver.go/receivedReports
	...
	RebootsCurrentDay             int32                  `protobuf:"varint,5,opt,name=rebootsCurrentDay,proto3" json:"rebootsCurrentDay,omitempty"`                        // ???
	LastRamReadMB                 int64                  `protobuf:"varint,6,opt,name=lastRamReadMB,proto3" json:"lastRamReadMB,omitempty"`                                // (1-measure.Integers["vm_used_percent"])*measure.Integers["vm_free"]
	LastDiskReadGB                int64                  `protobuf:"varint,7,opt,name=lastDiskReadGB,proto3" json:"lastDiskReadGB,omitempty"`                              // measure.Integers["DISK_USAGE"]
	LasCPUAvg                     int32                  `protobuf:"varint,8,opt,name=lasCPUAvg,proto3" json:"lasCPUAvg,omitempty"`                                        // measure.Integers["CPU_AVG"]
	Timestamp                     *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                                         //the time when this measure was collected
}
...
func (x *StatusReport) GetRebootsCurrentDay() int32 {
	if x != nil {
...
func (x *StatusReport) GetLastRamReadMB() int64 {
	if x != nil {
		return x.LastRamReadMB
	}
	return 0
}

func (x *StatusReport) GetLastDiskReadGB() int64 {
	if x != nil {
		return x.LastDiskReadGB
	}
	return 0
}

func (x *StatusReport) GetLasCPUAvg() int32 {
	if x != nil {
		return x.LasCPUAvg
	}
	return 0
...
var file_report_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaa, 0x03, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74,
	...
	,
